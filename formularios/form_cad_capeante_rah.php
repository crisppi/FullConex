...
/* --- FORÇAR LARGURA TOTAL NESTA PÁGINA --- */

/* Se o form estiver dentro de .container/.container-* do Bootstrap,
     expande só esta página sem afetar as demais */
.container:has(#form-capeante-rah),
.container-sm:has(#form-capeante-rah),
.container-md:has(#form-capeante-rah),
.container-lg:has(#form-capeante-rah),
.container-xl:has(#form-capeante-rah),
.container-xxl:has(#form-capeante-rah) {
    max-width: 100% !important;
    padding-left: 0 !important;
    padding-right: 0 !important;
}

/* O próprio form passa a ocupar a tela toda */
form#form-capeante-rah {
    max-width: none !important;
    width: 100% !important;
    margin: 0 !important;
    padding-left: 8px;
    /* ajuste fino da “borda” lateral */
    padding-right: 8px;
    /* pode trocar para 0 se quiser colado na borda */
}

/* Opcional: deixa os cards visualmente “esticados” sem parecer espremidos */
@media (min-width: 1200px) {
    .tuss-grid {
        grid-template-columns: minmax(280px, 2fr) 120px 180px 180px 180px 1.2fr;
    }
}
</style>
<style>
/* Se o form estiver dentro de .container do Bootstrap, libera largura total */
.container:has(#form-capeante-rah) {
    max-width: 100% !important;
}

/* GRID RESPONSIVO ESTÁVEL: 1→2→3→4→6 colunas conforme a largura */
.form-line-grid {
    display: grid;
...
/* Aparência */
.form-line-grid .form-label {
    margin-bottom: 4px;
    font-weight: 600;
}

.form-line-grid .form-control,
.form-line-grid .form-select {
    height: 36px;
}

/* Deixa “Número da Parcial” com possibilidade de ocupar 2 colunas quando houver espaço */
.form-line-grid .fg-parcial-num {
        ...
        <div class="sec-body">
            ...
            <div class="form-line-grid">
                ...
                <div class="form-group">
                    ...
                    <?php $encerradoVal = ($fv('encerrado_capeante') ?? 'n'); ?>
                    <select name="encerrado_capeante" class="form-select" id="encerrado_capeante">
