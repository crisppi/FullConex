<div class="row">
    ...
    <form class="formulario visible" action="<?= $BASE_URL ?>process_internacao.php" id="add-internacao-form"
        ...
        <div class="form-group row">
            ...
            <div class="form-group col-sm-2">
                ...
                <input type="date" class="form-control" id="data_intern_int" value="<?php echo date('Y-m-d') ?>"
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-2">
                ...
                <select class="form-control" id="especialidade_int" name="especialidade_int">
                    ...
                    <?php
                    $dados_especialidade = is_array($dados_especialidade ?? null) ? $dados_especialidade : [];
            ...
            <div class="form-group row">
                <div>
                    ...
                    <textarea type="textarea" rows="20" class="form-control" id="rel_int" name="rel_int"
                        placeholder="Relatório da auditoria"></textarea>
                </div>
                <div>
                    <label for="acoes_int">Ações Auditoria</label>
                    <textarea rows="20" type="textarea" class="form-control" id="acoes_int" name="acoes_int"
                        placeholder="Ações de auditoria"></textarea>
                </div>
                <div class="form-group col-sm-3">
                    <?php $agora = date('Y-m-d'); ?>
                    <input type="hidden" class="form-control" id="data_create_int" value='<?= $agora; ?>'
                        name="data_create_int" placeholder="Digite o nome do médico">
                </div>
            </div>
            <br>
