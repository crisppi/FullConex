...
$labelAntecedente = "COALESCE(NULLIF(p.patologia_pat,''), 'Sem informacoes')";
...
$rowsDiarias = distQuery($conn, $labelAntecedente, $sqlBase, $params, "SUM(GREATEST(1, DATEDIFF(COALESCE(al.data_alta_alt, CURDATE()), i.data_intern_int) + 1))", 10);
...
<div class="bi-wrapper bi-theme">
    ...
    <div class="bi-grid fixed-2" style="margin-top:16px;">
        ...
        <div class="bi-panel">
            <h3>Internacoes por antecedente</h3>
